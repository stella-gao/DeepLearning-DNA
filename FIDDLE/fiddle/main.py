...
flags.DEFINE_integer('savePredictionFreq', 10, 'frequency of saving prediction profiles to be plotted')
...
flags.DEFINE_float('learningRate', 0.0001, 'initial learning rate.')
...
def main(_):
    ...
    to_size = min(validation_h5_handle.values()[0].shape[0], 5000)
